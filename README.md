...
SSID: CETI
channel: 1
<img width="921" height="345" alt="image" src="https://github.com/user-attachments/assets/35e0b20b-11b0-4e91-8200-edab40275370" />

-  Lanzamiento del Evil Twin: Lanzamos el ataque con sudo hostapd-wpe /etc/hostapd-wpe/hostapd-wpe.conf, creando una web falsa para que la victima intente conectarse:
  <img width="585" height="94" alt="image" src="https://github.com/user-attachments/assets/61cf763b-18f5-413b-b9f8-5a2ddd13056f" />
- Movil conectandose: Vamos al movil victima  y podremos ver que hay 2 redes CETI:
<img width="1080" height="1543" alt="image" src="https://github.com/user-attachments/assets/5d699bc0-7f9f-4b3b-a563-d4fc516ca73f" />
Ponemos el usuario y contraseña que en este caso sera ceti ceti:
<img width="1080" height="1579" alt="image" src="https://github.com/user-attachments/assets/c266f8b6-09cf-4bae-b1e0-03d04804866d" />
 Dara error de conexión ya que esta red no tiene salida a internet:
<img width="1080" height="1996" alt="image" src="https://github.com/user-attachments/assets/51042f71-4e85-4aa0-a900-e8aa17666459" />

- Captura del Handshake: Volviendo a la Kali atacante podremos ver que esta ha capturado el nombre del usuario y el hash de la contraseña:
<img width="900" height="221" alt="image" src="https://github.com/user-attachments/assets/6a827c85-1835-4f7a-99a9-15fec7e495d1" />

- Crackeo del hash: Con el comando hashcat -m 5500 -O "ceti::::3bfe0ba926296a303838784b198430e75d02059ac8f8e4db:586c7468948ace3b" pass.txt --outfile resultado.txt usamos la herramienta hashcat para descubrir la contraseña mediante el diccionario pass.txt que incluye contraseñas entre ellas, la de ceti y redigimos el resultado a un txt llamado resultado.txt 
<img width="884" height="60" alt="image" src="https://github.com/user-attachments/assets/02833e5a-b816-4cb5-86d3-8145f2c09a29" />
Abrimos el txt con resultado y podremos ver el usuario, el hash  y tras el hash la contraseña:
<img width="710" height="80" alt="image" src="https://github.com/user-attachments/assets/7370a817-be92-45b0-9d46-112fbb1db070" />
